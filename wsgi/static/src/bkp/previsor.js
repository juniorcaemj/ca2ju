      ...
      /* function init(){
        ...
        */
		...
		function init() {
								...
								form.setAttribute("action", "previsao");
       ...
       function init2(){
								...
								form.setAttribute("method", "post");
								form.style.visibility = "hidden";
								form.setAttribute("action", "ngram");
       ...
       function pause(){
            ...
            case (lista):
                if (clist - 1 != -1){
                    var tokens = document.getElementById("p" +(clist - 1)).textContent.split(' ');
                    if (tokens[0]==vazio){
                        tokens[0] = tokens[1]
                    }
                    ...
                    if (document.getElementById("p" +(clist - 1)).value == "INICIAL"){
						document.getElementById("estado007").value = inicial;
							...
							palavras = document.getElementById("caixa1").textContent.split(' ');
